...
SELECT d.h3_index,
       ...
       ROUND(
         d.total_population / GREATEST(
           MIN(ST_DISTANCE(H3_CELL_TO_BOUNDARY(d.h3_index), r.geo)) / 1000,
           0.1
         ),
         2
       ) AS flood_risk,
...
GROUP BY d.h3_index, d.poi_count, d.total_population, d.amenity_types, d.hex_boundary;
